...
//       var errorMessage = "some error, plase try agen leater.";
...
//     } catch (error) {
//       const errorMessage = "Check internet connection";
//       _showErrorDialog(errorMessage);
//     }
...
//                   ),
//                   // TextButton(
//                   //   child: Text("checkConnection"),
//                   //   onLongPress: _checkConnection,
...
class _AuthCardState extends State<AuthCard>
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      const errorMessage = "Check internet connection or try agan later";
      _showErrorDialog(errorMessage);
    }
